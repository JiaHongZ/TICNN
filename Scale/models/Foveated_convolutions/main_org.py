...
class FoveatedConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, input_size=112, pool=False):
        super().__init__()
...
class Net(nn.Module):
    def __init__(self, classnum=10, full_affine=False, in_channels=1):
...
class FoveaNet(Net):
    def __init__(self, inchannels, outchannels, classnum, full_affine=False, pool=False, input_size=112):
        super().__init__(classnum=classnum, full_affine=full_affine, in_channels=inchannels)
        self.conv1 = FoveatedConv2d(inchannels, outchannels, input_size=input_size, pool=pool)


class MultiScaleNet(Net):
    def __init__(self, inchannels, outchannels, classnum, full_affine=False, pool=False, input_size=112):
        super().__init__(classnum=classnum, full_affine=full_affine, in_channels=inchannels)
        self.conv1 = FoveatedConv2d(inchannels*3, outchannels, input_size=input_size, pool=pool)
